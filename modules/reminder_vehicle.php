...
if ( count($_POST) > 0 ) {
	if ( $_POST['typ'] === 'ind' ) {
 		 ...
 		 $query = "SELECT vehicle_id, termin, nazwa FROM vehicle_deadlines WHERE termin > '$currentDate';";
  		...
  		$query = "SELECT vehicle_id, termin, nazwa FROM vehicle_deadlines WHERE termin > '$currentDate' AND termin <= '$endDate';";
		  //var_dump($query);
	}
	...
	if ( mysqli_num_rows($result) > 0 ) {
	  echo "<table class=\"moduleTable\">
			...
			<th class=\"tableHeaderCell\">Marka</th>
