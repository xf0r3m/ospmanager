<?php
	...
	echo "<form action=\"index.php?page=event_eq&type=eqManual&action=mod&id=" . $mod_id . "\" method=\"post\">";
	echo "<input class=\"form_inputs\" type=\"hidden\" name=\"e_eqManual_event_id\" value=\"" . $event_id . "\" />";

				echo "<table>
				<tr>
				<td>Sprzęt: </td>
				<td><select class=\"form_inputs\" name=\"e_eqManual_eq_id\">
	...
	echo "</select></td>
				...
				<tr>
				<td>Czas użycia: </td>
				<td><input class=\"form_inputs\" type=\"time\" name=\"e_eqManual_czas\" value=\"" . $row0[1] . "\" /></td>
				</tr>";

	echo "<tr>
				<td>Uwagi: </td>
				<td><input class=\"form_inputs\" type=\"text\" name=\"e_eqManual_uwagi\" value=\"" . $row0[2] . "\" /></td>
				</tr>
				</table>
